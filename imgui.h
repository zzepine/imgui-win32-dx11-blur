...
enum ImGuiWindowFlags_
{
    ...
    ImGuiWindowFlags_BlurredBg              = 1 << 19,  // Enable background blur rendering for this window.
...
enum ImGuiStyleVar_
{
    ...
    ImGuiStyleVar_WindowBgBlur,             // float     WindowBgBlur
    ImGuiStyleVar_WindowBgBlurQuality,      // float     WindowBgBlurQuality
...
#define ImDrawCallback_ApplyBlur            (ImDrawCallback)(-9)
...
struct ImDrawList
{
    ...
    IMGUI_API void  AddBlur(const ImVec2& p_min, const ImVec2& p_max, float amount, int quality = 0);
